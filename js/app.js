...
import initalizeMenu from './menu.js';
import setupRouting from './routing.js';
import loadVisitAnimations from './animations.js';
import initLocalization from './localization.js';

window.addEventListener('load', function (e) {
    console.log("Is iOS:\t" + iOS())
    console.log("Mobile Check:\t" + iOS())
    if (window.mobileCheck() || iOS()) {
        console.log("[App] Detected Mobile!")

        // Load Visiting Animations.
        loadVisitAnimations();
        ...
        //This will disable cursor on Smartphones & Tablets.
        ...
        console.log("[App] Detected Desktop!")
